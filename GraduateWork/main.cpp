...
int main() {
	...
	*/
	...
	for (int k = 0; k < 100; ++k) {
		...
		out << std::endl << "avg body: " << results[1] << std::endl;
		out << "avg wings: " << results[2] << std::endl;
		out << "avg empennage: " << results[3] << std::endl;
		out << "avg cam: " << results[4] << std::endl;
		out << "avg armament: " << results[5] << std::endl;
		out << "avg navigation: " << results[6] << std::endl;
		out << "avg flaps: " << results[7] << std::endl;
		out << "avg elevator: " << results[8] << std::endl;
		out << "avg engine: " << results[9] << std::endl;
		out << "avg propeller: " << results[10] << std::endl;
		out << "avg fuel tank: " << results[11] << std::endl;
